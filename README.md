...
# 简介
1. 本项目使用盘古、伏羲、风乌气象大模型三大 AI 大模型对台风进行预报和检验
2. 基于 ERA5 再分析数据，实现了对2609号台风（代号：巴威）的路径预报。
3. 支持台风核心要素检验，可定量计算台风路径误差、中心气压偏差、最大风速 RMSE/MAE等评估指标。
4. 预报检验的时间范围：2026年7月6日6时~2026年7月19日06时（UTC时间）
5. 预报检验的时间分辨率：逐6小时
